...
//Imports Rockabilly - Componentes Material-ui
...
/**
  ...
  handleSendSigningRequest = (event) =>{
    ...
    fetchApi(
      'post',
      'http://localhost:8080/cmd/dssFiler2Sign',
      {
  ...
  handleSendOtp = (event) =>{
    ...
    fetchApi(
      'post',
      'http://localhost:8080/cmd/dssFiler2SendOTP',
      {
        otp:this.state.otp,
  ...
  return (
    <Grid xs={12}>
      ...
      <Dialog open={this.state.openOTP} onClose={this.handleClose} aria-labelledby="form-dialog-title">
        ...
        <DialogContent>
          <DialogContentText>
            Insira o código que recebeu no seu telemóvel.
          </DialogContentText>
          <TextField
            autoFocus
...
export default withStyles(styles) (Cmd);